...
static inline uint8_t lcd_get_position_page(void)
{
	return lcd_current_page;
}

static inline uint8_t lcd_get_position_column(void)
{
...
#define LCD_SELECT()         CSB_SetLow();
#define LCD_UNSELECT()       CSB_SetHigh();
#else
