...
(library Library_1
	...
	(compDef "TCAN330GD" (originalName "TCAN330GD") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "5" (pinName "SHDN") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tcan330g")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TCAN330GD.stp")
